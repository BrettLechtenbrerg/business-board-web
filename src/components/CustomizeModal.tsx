...
const STORAGE_KEY = 'business-board-advisors';
      ...
      <div className="relative w-full max-w-2xl max-h-[85vh] overflow-hidden rounded-2xl border border-white/10 bg-gray-900/95 shadow-2xl">
        ...
        <div className="overflow-y-auto p-6" style={{ maxHeight: 'calc(85vh - 140px)' }}>
          ...
          <div className="mb-6 p-4 rounded-xl border border-purple-500/20 bg-purple-500/5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-purple-300 mb-2">How to customize your board:</h3>
              ...
              return (
                <button
                  ...
                  className={`relative flex flex-col items-center gap-2 p-4 rounded-xl border transition-all active:scale-95 ${
                    isActive ? colorMap[advisor.color] || colorMap.purple : inactiveColor
                  }`}
                >
                  {isActive && (
        ...
        <div className="sticky bottom-0 border-t border-white/10 bg-gray-900/95 px-6 py-4 flex gap-3">
          ...
          <button
            ...
            className="flex-1 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-violet-500 text-white font-medium hover:from-purple-500 hover:to-violet-400 transition-all disabled:opacity-30 disabled:cursor-not-allowed"
          >
